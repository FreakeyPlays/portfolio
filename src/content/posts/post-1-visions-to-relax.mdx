...
slug: maybach-visions-to-relax-a-mixed-reality-game-for-autonomous-cars
intro: The passenger of a **Maybach** looks up and sees space. Loose stars float around the interior. Grab one, move it, and it snaps into a constellation. That's **Visions to Relax**, an **Apple Vision Pro** app two of us built during a project semester with **Mercedes-Benz AG**, exploring what you actually do in a car once you stop driving it.
faq:
  - question: What is Maybach - Visions to Relax?
    answer: Maybach - Visions to Relax is a VR application for the Apple Vision Pro that aims to calm the user with a small game.
  ...
  - question: Doesn't VR in a moving car make you sick?
    answer: Yes it does! The inner ear feels the movement while your eyes see something else. Thats why we chose to place the game on the ceiling so the windows remain open and the User can see the real movement.
...
This was more important than it sounds because we needed to decide which elements to take from interactive games and which from calm ones. An app that relaxes someone but cannot hold their attention for more than a few minutes is a failure. So has one that holds attention by winding them up. We were looking for the right balance.
