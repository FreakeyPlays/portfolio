...
import { mdastTableOfContentsPlugin } from '@utils/mdastTableOfContentsPlugin';
...
export default defineConfig({
  ...
  markdown: {
    processor: satteri({ mdastPlugins: [mdastReadingTimePlugin(), mdastTableOfContentsPlugin()] }),
  },
