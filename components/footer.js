...
const Footer = () => {
  return (
    <footer className="flex justify-center pt-8 pb-8 xl:pb-40 lg:pb-32">
      <div className="">
        <div className="mb-2">
          <FooterElement uri="https://github.com/FreakeyPlays" text="GitHub" />
          <FooterElement
          ...
          <FooterElement
            ...
            text="XING"
          />
          <FooterElement uri="mailto:contact@chrismerck.me" text="Contact Me" />
        </div>
        <div className="text-footer-copyright text-center">
          &copy; {new Date().getFullYear()} Christoph Merck. All Rights
          Reserved.
        </div>
      </div>
    </footer>
