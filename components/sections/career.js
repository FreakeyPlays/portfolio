        ...
        <div className="ml-4">
          {(Object.entries(careerContent) || []).map(([key, value]) => {
            return (
              ...
              >
                <h1 className="text-[2rem] uppercase font-bold lg:text-2xl sm:text-xl">
                  {value.title}
                </h1>
                <p className="text-l-primary dark:text-d-primary text-2xl lg:text-xl font-bold mt-2">
                  {'@' + value.institute}
                </p>
                <p className="text-comment text-2xl lg:text-xl uppercase mb-4">
