...
const Skills = () => {
    ...
    const [selectedSection, setSelectedSection] = useState(Object.keys(skillsContent)[0])
            ...
            <div className="w-3/4 lg:w-full flex flex-row">
                ...
                {(Object.entries(skillsContent) || []).map(([key, value]) => {
                    return(
                        <div 
                            key={"content-" + key}
                            className={`text-format grid grid-cols-[repeat(auto-fit,minmax(32px,128px))] gap-2 
                                ...
                                return(
                                    <div 
                                        ...
                                        className="bg-gradient-to-t from-l-bg dark:from-d-bg to-[#ebebea99] dark:to-[#24272799] 
                                                   p-2 rounded-xl flex flex-col gap-2 justify-between items-center border-solid border-[1px] 
