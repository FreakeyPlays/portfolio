...
const NavBar = () => {
    ...
    return(
        <>
            ...
            <nav className="w-32 xl:w-[90vw] h-[80vh] xl:h-24 lg:h-16 max-h-[calc(1080px-256px)] fixed flex flex-col xl:flex-row right-0 xl:right-1/2 
            ...
            >
                ...
                <div className="w-32 xl:w-[calc(100%-192px)] lg:w-full h-[calc(100%-256px)] xl:h-full flex flex-col justify-center
